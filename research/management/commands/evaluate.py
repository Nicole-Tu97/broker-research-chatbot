...
class Command(BaseCommand):
    ...
    def render_report(self, results) -> str:
        ...
        if r:
            ...
            L.append("- **The answer keys were drafted by an LLM and checked by me:** I manually reviewed a")
            L.append("  random sample of the keys against the source pages. The chatbot under test never")
            L.append("  saw them.")
