...
class Command(BaseCommand):
    ...
    def render_report(self, results) -> str:
        ...
        if r:
            ...
            L.append("- **The answer keys were drafted by an LLM from the source pages, then checked:** every")
            L.append("  expected fact was verified by code to appear on the expected page, and the keys were")
            L.append("  spot-checked by hand. The chatbot under test never saw them.")
